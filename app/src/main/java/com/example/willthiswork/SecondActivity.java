...
public class SecondActivity extends AppCompatActivity implements View.OnTouchListener, CameraBridgeViewBase.CvCameraViewListener2 {
        ...
        public void onManagerConnected(int status) {
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    mOpenCvCameraView.setOnTouchListener(SecondActivity.this);
                } break;
                default:
                {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.second_activity_layout); // color blob code
        ...
        public void onDestroy()
    {
        ...
        public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) { // color blob detection
